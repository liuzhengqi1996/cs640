...
ovs-vsctl set bridge s5 protocols=OpenFlow10
ovs-vsctl set bridge s6 protocols=OpenFlow10
...
ovs-vsctl set bridge r5 protocols=OpenFlow10
ovs-vsctl set bridge r6 protocols=OpenFlow10
